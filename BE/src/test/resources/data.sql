insert into `map` (name, full_disclosure, member_id) values ('first map', true, 1);
...
insert into `place` (name, latitude, longitude, description, map_id, category_id, member_id) values ('star', 127.00, 37.000, 'second place', 1, 1, 1);
