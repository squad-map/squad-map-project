insert into `map` (name, is_private, member_id) values ('first map', false, 1);
...
insert into `member` (nickname, profile_image, email, resource_server) values ('nickname', 'image', 'email', 'provider');
