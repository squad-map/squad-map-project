...
insert into `place` (name, address, latitude, longitude, description, detail_link, map_id, category_id, member_id) values ('starbucks', 'my hometown', 127.00, 37.000, 'first place', 'https://kakaomap', 1, 1, 1);
insert into `place` (name, address, latitude, longitude, description, detail_link, map_id, category_id, member_id) values ('star', 'visited yesterday', 127.00, 37.000, 'second place', 'https://kakaomap', 2, 3, 1);
