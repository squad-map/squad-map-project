...
include::{snippets}/group_member_acceptance_test/delete_group_member_test/request-fields.adoc[]
include::{snippets}/group_member_acceptance_test/delete_group_member_test/request-body.adoc[]
